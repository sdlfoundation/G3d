...
#define NW_G3D_DEPRECATED_FUNCTION_MSG(MFunc, msg)                             \
  MFunc __attribute__((deprecated))

#define NW_G3D_DEPRECATED_FUNCTION(MFunc)                                      \
  NW_G3D_DEPRECATED_FUNCTION_MSG(MFunc, "## g3d deprecated function ##")

#define NW_G3D_MAKE_U8X4_AS_U32(a, b, c, d)                                    \
  static_cast<u32>((static_cast<u8>(a) << 24) | (static_cast<u8>(b) << 16) |   \
...
#define NW_G3D_VERSION                                                         \
  NW_G3D_MAKE_U8X4_AS_U32(NW_G3D_VERSION_MAJOR, NW_G3D_VERSION_MINOR,          \
                          NW_G3D_VERSION_MICRO, NW_G3D_VERSION_BINARYBUGFIX)
